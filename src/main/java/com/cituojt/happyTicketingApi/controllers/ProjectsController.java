...
public class ProjectsController {
        ...
        @RequestMapping(value = "/api/v1/projects/{id}/tasks", produces = "application/json", method = RequestMethod.POST)
        public ResponseEntity addTask(@PathVariable("id") long id, @RequestParam("name") String name,
