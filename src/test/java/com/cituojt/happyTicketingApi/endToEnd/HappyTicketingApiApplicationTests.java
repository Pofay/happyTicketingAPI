...
public class HappyTicketingApiApplicationTests {
        ...
        @Test
        public void withFoundEmail_addingGroupMembersToProjectReturns201WithMembersFieldChanged() throws Exception {
                Project p = new Project("Hotel Management");
        ...
        @Test
        public void withNoMatchingEmail_addingMembersToProjectReturns403WithErrorMessage() throws Exception {
                Project p = new Project("Hotel Management");
                User u1 = new User("pofay@example.com", "auth0|5d4185285fa52d0cfa094cc1");
                p.addMember(u1, "OWNER");
                projectRepo.save(p);
